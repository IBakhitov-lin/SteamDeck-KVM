...
function Показать-Сообщение {
    ...
    Шапка-Окна $диалог -Заголовок ' '   # название уже крупно в самом диалоге
...
function New-AppWindow {
    ...
    # Шапку, стекло и скругление ставит `Шапка-Окна` библиотеки в конце сборки — один вид всех окон.
    ...
    # Своя шапка на стекле вместо чёрной системной полосы; высоты окна растут на её высоту.
    Шапка-Окна $окно
    $высотаБезОбновления += $окно.СвояШапка
    $высотаСОбновлением += $окно.СвояШапка
